...
#arrange data
#df <- read.csv("junk.sabrina.chl.predictors.csv")
df <- temp
...
library(MASS)
#acid data
acid <- read.csv("junk.acid.for.sabrina.csv")
...
# vars <- data.frame(characteristic=c("a","b","c","d","e","f","g","h","i","j"),
#                    min=1,
#                    q1=1,
#                    median=1,
#                    median=1,
...
vars[nrow(vars)+1,] <- c("ACID DEPOSITION",
...
# lm.acid.a <- lm(res~acid, data=acid.a)
# p1 <- ggplot(data=acid.a, aes(x=acid,y=res))+
#   geom_point()+
#   geom_smooth(method='lm')+ 
#   # scale_x_continuous(limits=c(min(acid$acid),max(acid$acid))) + 
#   # geom_rug(col=rgb(0,0,0,alpha=.2),sides = "b")+
#   labs(x="ACID DEPOSITION (DIN:TP>1.5)",
#        y='residuals of LM(logCHLA~logTP)') #plot
# p2 <- ggplot(data=acid.a, aes(x=acid))+
#   geom_density(fill="grey")+
#   theme(axis.title.x=element_blank(),
#         axis.text.x=element_blank(),
#         axis.ticks.x=element_blank(),
...
#                            paste(min(as.numeric(na.omit(acid.a$acid))),
#                                  "-",max(as.numeric(na.omit(acid.a$acid)))),
#                            nrow(acid.a),
#                            paste(median(as.numeric(na.omit(acid.a$acid))),
#                            "(",summary(as.numeric(na.omit(acid.a$acid)))[2],
#                            "-",summary(as.numeric(na.omit(acid.a$acid)))[5],")"))
# 
# lm.acid.b <- lm(res~acid, data=acid.b)
# p1 <- ggplot(data=acid.b, aes(x=acid,y=res))+
#   geom_point()+
#   geom_smooth(method='lm')+ 
#   # scale_x_continuous(limits=c(min(acid$acid),max(acid$acid))) + 
#   # geom_rug(col=rgb(0,0,0,alpha=.2),sides = "b")+
#   labs(x="ACID DEPOSITION (DIN:TP<1.5)",
#        y='residuals of LM(logCHLA~logTP)') #plot
# p2 <- ggplot(data=acid.b, aes(x=acid))+
#   geom_density(fill="grey")+
#   theme(axis.title.x=element_blank(),
#         axis.text.x=element_blank(),
#         axis.ticks.x=element_blank(),
...
# stats[nrow(stats)+1,] <- c("ACID DEPOSITION (DIN:TP<1.5)",
#                            coef(lm.acid.b),
#                            summary(lm.acid.b)$coefficients[2,4],
#                            summary(lm.acid.b)$r.squared) #coefficients
# vars[nrow(vars)+1,] <- c("ACID DEPOSITION (DIN:TP<1.5)",
#                            paste(min(as.numeric(na.omit(acid.b$acid))),
#                                  "-",max(as.numeric(na.omit(acid.b$acid)))),
#                            nrow(acid.b),
#                            paste(median(as.numeric(na.omit(acid.b$acid))),
#                            "(",summary(as.numeric(na.omit(acid.b$acid)))[2],
#                            "-",summary(as.numeric(na.omit(acid.b$acid)))[5],")"))
...
p1 <- ggplot(data=merge, aes(x=precip,y=NULL))+
  ...
  # scale_x_continuous(limits=c(min(merge$precip),max(merge$precip))) + 
  # geom_rug(col=rgb(0,0,0,alpha=.2),sides = "b")+
...
# #nitrate/nitrite
# lm.below <- lm(res.lm ~ `NITROGEN, NITRATE-NITRITE_OW_T`,sub.below)
# p1 <- ggplot(data=sub.below,aes(x=`NITROGEN, NITRATE-NITRITE_OW_T`,y=res.lm)) +
#   geom_point() +
#   geom_smooth(method="lm") +
#   labs(x="NITRATE+NITRITE (DIN:TP<1.5)",
#        y='residuals of LM(logCHLA~logTP)')
# p2 <- ggplot(data=sub.below, aes(x=`NITROGEN, NITRATE-NITRITE_OW_T`))+
#   geom_density(fill="grey")+
#   theme(axis.title.x=element_blank(),
#         axis.text.x=element_blank(),
#         axis.ticks.x=element_blank(),
...
#                            paste(min(as.numeric(na.omit(sub.below$`NITROGEN, NITRATE-NITRITE_OW_T`))),
#                                  "-",max(as.numeric(na.omit(
#                                    sub.below$`NITROGEN, NITRATE-NITRITE_OW_T`)))),
#                            nrow(sub.below),
#                            paste(median(as.numeric(na.omit(sub.below$`NITROGEN, NITRATE-NITRITE_OW_T`))),
#                            "(",summary(as.numeric(na.omit(
#                              sub.below$`NITROGEN, NITRATE-NITRITE_OW_T`)))[2],
#                            "-",summary(as.numeric(na.omit(
#                              sub.below$`NITROGEN, NITRATE-NITRITE_OW_T`)))[5],")"))
# 
# lm.above <- lm(res.lm ~ `NITROGEN, NITRATE-NITRITE_OW_T`,sub.above)
# p1 <- ggplot(data=sub.above,aes(x=`NITROGEN, NITRATE-NITRITE_OW_T`,y=res.lm)) +
#   geom_point() +
#   geom_smooth(method="lm") +
#   labs(x="NITRATE+NITRITE (DIN:TP>1.5)",
#        y='residuals of LM(logCHLA~logTP)')
# p2 <- ggplot(data=sub.above, aes(x=`NITROGEN, NITRATE-NITRITE_OW_T`))+
#   geom_density(fill="grey")+
#   theme(axis.title.x=element_blank(),
#         axis.text.x=element_blank(),
#         axis.ticks.x=element_blank(),
...
# vars[nrow(vars)+1,] <- c("NITRATE+NITRITE (DIN:TP>1.5)",
#                            paste(min(as.numeric(na.omit(sub.above$`NITROGEN, NITRATE-NITRITE_OW_T`))),
#                                  "-",max(as.numeric(na.omit(
#                                    sub.above$`NITROGEN, NITRATE-NITRITE_OW_T`)))),
#                            nrow(sub.above),
#                            paste(median(as.numeric(na.omit(sub.above$`NITROGEN, NITRATE-NITRITE_OW_T`))),
#                            "(",summary(as.numeric(na.omit(
#                              sub.above$`NITROGEN, NITRATE-NITRITE_OW_T`)))[2],
#                            "-",summary(as.numeric(na.omit(
#                              sub.above$`NITROGEN, NITRATE-NITRITE_OW_T`)))[5],")"))

#color (high/low)
a<-df2[df2$`True color`<=20,]
b<-df2[df2$`True color`>20,]
b$`True color` <- log(as.numeric(b$`True color`))

p1 <- ggplot(data=a, aes(x=`True color`,y=res.lm))+
  geom_point()+
  geom_smooth(method='lm')+
  labs(x="Low color",
       y='residuals of LM(logCHLA~logTP)') #plot
p2 <- ggplot(data=a, aes(x=`True color`)) +
  geom_density(fill="grey") +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
p1 <- ggplot(data=b, aes(x=`True color`,y=res.lm))+
  geom_point()+
  geom_smooth(method='lm')+
  labs(x="Log(high color)",
       y='residuals of LM(logCHLA~logTP)') #plot
p2 <- ggplot(data=b, aes(x=`True color`)) +
  geom_density(fill="grey") +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
alm <- lm(res.lm~`True color`,a)
blm <- lm(res.lm~`True color`,b)
...
slope.plot <- ggplot(coeffs) +
  ...
  geom_dotplot(binaxis='y',stackdir='center', dotsize=0.5, show.legend = FALSE,aes(x=x,y=slope,fill=sig,colour=sig)) +
